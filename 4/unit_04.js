...
function f5() {
    let f4 = document.querySelector('.i-5');
    if (f4.checked) {
        document.querySelector('.out-5').textContent = f4.value
    }
    else
...
function f6() {
    let f5 = document.querySelector('.i-6').value;
    document.querySelector('.out-6').textContent = f5
}
...
function f7() {
    ...
    document.querySelector('.out-71').textContent = password;
...
function f9() {
    data = document.querySelector('.r-9')
    if (data.checked) {
...
function f15() {
    data = document.querySelector('.i-15').value
    document.querySelector('.t-15').textContent = data
...
function f16() {
    data = document.querySelector('.s-16').value;
...
function f17() {
    data = document.querySelector('.s-17').value;
...
function f18() {
    data = document.querySelector('.s-18').value;
    document.querySelector('.i-18').value = data;
}
...
function f20() {
    let data = document.querySelector('.s-201').value;
    document.querySelector('.s-202').value = data;
}
